 ...
 * Класс валидации для создания новой акции/спецпредложения
 */
...
class CreatePromotionRequest {
    ...
    /**
     * Получить очищенные данные (sanitized)
     */
    sanitized() {
        return {
    ...
    validatePrices() {
        ...
        // Проверка логики: если обе цены установлены, новая должна быть меньше старой
        if (price_old && price_new) {
